...
<body>
<form action = "detailStmt.htm" method = "post">
<table>
<tr>
...
<tr>
<td>Enter Initial Date</td>
<td><input type = "date" name = "inidate"></td>
</tr>
<tr>
<td>Enter Final Date</td>
<td><input type = "date" name = "findate"></td>
</tr>
<tr>
