				...
				<div id="openAccountDiv">
					...
					<div id="openAccountForm">
						...
						<form action="openAccount.htm" method="post">
							...
							<p>
								<label for="openFormUserName">Customer Name</label> <input
									type="text" name="openFormUserName" id="openFormUserName"
									required placeholder="Enter your name" />
							</p>

							<p>
								<label for="openFormUseremail">Email</label> <input type="email"
									name="openFormUseremail" id="openFormUseremail" required
									placeholder="Enter your email id" />
							</p>

							<p>
								<label for="openFormUserAddress">Address</label> <input
									type="text" name="openFormUserAddress" id="openFormUserAddress"
									required placeholder="Enter your address" />
							</p>

							<p>
								<label for="openFormUserPan">Pan Card</label> <input type="text"
									name="openFormUserPan" id="openFormUserPan"
							...
							<p>
								<label for="openUserAccountType">Select Account Type:
									...
									name="openUserAccountType" value="savings">&nbsp;Savings
								&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; <input
									type="radio" name="openUserAccountType" value="current">&nbsp;Current
							</p>
						...
						<div id="hr-fundTransfer">
							<div id="hr-ft-formContainer">
								...
								<form action="fundTransfer.htm" method="post">
									...
									<p>
										<label for="ft-describe">Payment description:</label> <input
											type="text" id="ft-describe" name="ft-describe"
											placeholder="Enter payment description:" required />
									</p>
									<p>
										<label for="ft-nickname">Nick name:</label> <input type="text"
											id="ft-nickname" name="ft-nickname"
											placeholder="Enter nick name for payee:" required />
									</p>
						...
						<div id="hr-changePassword">
							<div id="hr-ft-formContainer">
								...
								<form action="changePassword.htm" method="post">
									...
									<p>
										<label for="ft-oldpswd">Old Password:</label> <input
											type="password" id="ft-oldpswd" name="ft-oldpswd"
											placeholder="Enter your old password" required />
									</p>
									<p>
										<label for="ft-newpswd">New Password:</label> <input
											type="password" id="ft-newpswd" name="ft-newpswd"
											placeholder="Enter your new password" required />
									</p>
									<p>
										<label for="ft-confirmpswd">Confirm Password:</label> <input
											type="password" id="ft-confirmpswd" name="ft-confirmpswd"
